...
Optimum ONNX supports Transformers 4.36 through 4.57 and the latest Transformers 5 release. Older Transformers 5
minor releases are best-effort. MCTCT is available with Transformers 4 only because the architecture was removed from
Transformers 5; the remaining architectures below are supported on both majors.
