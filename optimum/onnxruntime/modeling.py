...
ONNX_MODEL_END_DOCSTRING = r"""
    This model inherits from [`~onnxruntime.modeling.ORTModel`], check its documentation for the generic methods the
    library implements for all its model (such as downloading or saving).

    This class should be initialized using the [`onnxruntime.modeling.ORTModel.from_pretrained`] method.
"""
